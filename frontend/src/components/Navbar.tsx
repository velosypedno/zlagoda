          ...
          <div className="hidden md:flex space-x-4">
            {isAuthenticated ? (
              <>
                ...
                <Link to="/receipts" className="text-gray-700 hover:text-blue-500 transition">Receipts</Link>
                ...
                {isCashier && (
                  <Link to="/create-receipt" className="text-gray-700 hover:text-blue-500 transition">Create Receipt</Link>
                )}
