...
const EmployeesPage = () => {
  ...
  const [newEmployee, setNewEmployee] = useState<
    Omit<Employee, "employee_id"> & { login: string; password: string }
  >({
    empl_surname: "",
    empl_name: "",
    empl_patronymic: "",
  ...
  const [sortField, setSortField] = useState<"empl_surname" | "empl_name">(
    "empl_surname",
  );
  ...
  const handleCreate = async () => {
    // Basic validation
    if (
      !newEmployee.empl_surname ||
      !newEmployee.empl_name ||
      !newEmployee.empl_role ||
      !newEmployee.salary ||
      !newEmployee.date_of_birth ||
      !newEmployee.date_of_start ||
    ...
    <div className="p-6 max-w-6xl mx-auto">
      <div className="flex justify-between items-center mb-6">
        ...
        <ExportPdfButton
          ...
          filename="employees-export.pdf"
          columns={[
            { key: "employee_id", label: "ID", width: "12%" },
            { key: "empl_surname", label: "Surname", width: "15%" },
            { key: "empl_name", label: "Name", width: "15%" },
            { key: "empl_role", label: "Role", width: "12%" },
      ...
      <div className="flex flex-wrap gap-2 mb-6 items-center">
        ...
        <select
          value={roleFilter}
          onChange={(e) =>
            setRoleFilter(e.target.value as "all" | "Manager" | "Cashier")
          }
        ...
        <select
          value={sortField}
          onChange={(e) =>
            setSortField(e.target.value as "empl_surname" | "empl_name")
          }
          className="border rounded px-2 py-2"
        >
      ...
      {isManager && (
        <>
          ...
          <button
            ...
            className="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 disabled:opacity-50 mb-8"
          >
            Add Employee
          </button>
        </>
        ...
        {Array.isArray(employees) &&
          employees
            .filter((employee) => {
              ...
              const roleOk =
                roleFilter === "all" || employee.empl_role === roleFilter;
              return (
                roleOk &&
                (!q ||
